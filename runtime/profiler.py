...
class CSVProfiler:
    ...
    def _detect_target_column(self, df: pd.DataFrame, columns: List[Dict]) -> Optional[str]:
        ...
        for col_info in columns:
            ...
            if not pd.api.types.is_numeric_dtype(col_series) and 2 <= col_series.nunique() <= 20:

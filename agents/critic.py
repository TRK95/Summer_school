...
class CriticAgent:
    ...
    def critique(self, code_output: Dict[str, Any], exec_result: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _build_critic_prompt(self, code_output: Dict[str, Any], exec_result: Dict[str, Any]) -> str:

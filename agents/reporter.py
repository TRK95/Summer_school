...
class ReporterAgent:
    ...
    def report(self, highlights: List[Dict[str, Any]], profile: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _build_reporter_prompt(self, highlights: List[Dict[str, Any]], profile: Dict[str, Any]) -> str:
...
"""
    ...
    def _create_fallback_report(self, highlights: List[Dict[str, Any]], profile: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if columns:
            ...
            for col in columns[:10]:  # First 10 columns
                ...
                markdown_parts.append(f"- **{name}**: {dtype} ({missing_pct:.1f}% missing)")
            markdown_parts.append("")

...
class CodeWriterAgent:
    ...
    def write_code(self, item: Dict[str, Any], profile: Dict[str, Any], save_dir: str = "./artifacts") -> Dict[str, Any]:
        """
    ...
    def _build_coder_prompt(self, item: Dict[str, Any], profile: Dict[str, Any], save_dir: str) -> str:
...
"""
    ...
    def _create_fallback_code(self, item: Dict[str, Any], save_dir: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "manifest_schema": {
                ...
                "charts": [{
                    ...
                    "n_rows_plotted": 0,
                    "axis": {"x": columns[0] if columns else "x", "y": "y", "log_x": False, "log_y": False, "x_ticks": 0, "y_ticks": 0},
